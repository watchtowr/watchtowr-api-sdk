...
> ClientSubdomainData get_asset_subdomain_details(api_token)
...
with watchtowr_api.ApiClient(configuration) as api_client:
    ...
    try:
        # Show the details of a a specific subdomain asset.
        api_response = api_instance.get_asset_subdomain_details(api_token)
...
> PaginatedClientSubdomain get_list_asset_subdomains(asset_name=asset_name, statuses=statuses, business_unit_ids=business_unit_ids, page=page, created_from=created_from, created_to=created_to, updated_from=updated_from, updated_to=updated_to)
...
with watchtowr_api.ApiClient(configuration) as api_client:
    ...
    try:
        # List all discovered subdomains, ordered by date identified.
        api_response = api_instance.get_list_asset_subdomains(asset_name=asset_name, statuses=statuses, business_unit_ids=business_unit_ids, page=page, created_from=created_from, created_to=created_to, updated_from=updated_from, updated_to=updated_to)
