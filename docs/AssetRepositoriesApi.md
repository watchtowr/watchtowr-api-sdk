# watchtowr_api.AssetRepositoriesApi

All URIs are relative to *http://localhost*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_asset_repository_details**](AssetRepositoriesApi.md#get_asset_repository_details) | **GET** /api/client/assets/repository/show/{id} | Show the details of a specific repository asset.
[**get_list_asset_repositories**](AssetRepositoriesApi.md#get_list_asset_repositories) | **GET** /api/client/assets/repository/list | List all discovered repositories, ordered by date identified.


# **get_asset_repository_details**
> ClientRepositoryData get_asset_repository_details(api_token)

Show the details of a specific repository asset.
...
with watchtowr_api.ApiClient(configuration) as api_client:
    ...
    api_instance = watchtowr_api.AssetRepositoriesApi(api_client)
    api_token = 'api_token_example' # str | 

    try:
        # Show the details of a specific repository asset.
        api_response = api_instance.get_asset_repository_details(api_token)
        print("The response of AssetRepositoriesApi->get_asset_repository_details:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AssetRepositoriesApi->get_asset_repository_details: %s\n" % e)
```
...
> PaginatedClientRepository get_list_asset_repositories(asset_name=asset_name, statuses=statuses, business_unit_ids=business_unit_ids, page=page, created_from=created_from, created_to=created_to, updated_from=updated_from, updated_to=updated_to)
...
with watchtowr_api.ApiClient(configuration) as api_client:
    ...
    try:
        # List all discovered repositories, ordered by date identified.
        api_response = api_instance.get_list_asset_repositories(asset_name=asset_name, statuses=statuses, business_unit_ids=business_unit_ids, page=page, created_from=created_from, created_to=created_to, updated_from=updated_from, updated_to=updated_to)
        print("The response of AssetRepositoriesApi->get_list_asset_repositories:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AssetRepositoriesApi->get_list_asset_repositories: %s\n" % e)
```
