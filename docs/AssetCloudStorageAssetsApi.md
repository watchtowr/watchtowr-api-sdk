# watchtowr_api.AssetCloudStorageAssetsApi

All URIs are relative to *http://localhost*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_asset_cloud_storage_details**](AssetCloudStorageAssetsApi.md#get_asset_cloud_storage_details) | **GET** /api/client/assets/cloudStorage/show/{id} | Show the details of a specific Cloud Storage asset.
[**get_list_asset_cloud_storages**](AssetCloudStorageAssetsApi.md#get_list_asset_cloud_storages) | **GET** /api/client/assets/cloudStorage/list | List all discovered Cloud Storage assets, ordered by date identified.
[**update_asset_cloud_storage_status**](AssetCloudStorageAssetsApi.md#update_asset_cloud_storage_status) | **PUT** /api/client/assets/cloudStorage/update-status/{id} | Update status of a specific cloud storage asset.


# **get_asset_cloud_storage_details**
> ClientCloudStorageData get_asset_cloud_storage_details(id, api_token)
...
with watchtowr_api.ApiClient(configuration) as api_client:
    ...
    api_instance = watchtowr_api.AssetCloudStorageAssetsApi(api_client)
    id = 3.4 # float | 
    api_token = 'api_token_example' # str | 

    try:
        # Show the details of a specific Cloud Storage asset.
        api_response = api_instance.get_asset_cloud_storage_details(id, api_token)
        print("The response of AssetCloudStorageAssetsApi->get_asset_cloud_storage_details:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AssetCloudStorageAssetsApi->get_asset_cloud_storage_details: %s\n" % e)
```
...
> PaginatedClientCloudStorage get_list_asset_cloud_storages(page=page, page_size=page_size, asset_name=asset_name, statuses=statuses, business_unit_ids=business_unit_ids, created_from=created_from, created_to=created_to, updated_from=updated_from, updated_to=updated_to)
...
with watchtowr_api.ApiClient(configuration) as api_client:
    ...
    asset_name = 'bucket.s3.amazonaws.com' # str | Keyword search in a Cloud Storage URL (optional)
    ...
    try:
        # List all discovered Cloud Storage assets, ordered by date identified.
        api_response = api_instance.get_list_asset_cloud_storages(page=page, page_size=page_size, asset_name=asset_name, statuses=statuses, business_unit_ids=business_unit_ids, created_from=created_from, created_to=created_to, updated_from=updated_from, updated_to=updated_to)
        print("The response of AssetCloudStorageAssetsApi->get_list_asset_cloud_storages:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AssetCloudStorageAssetsApi->get_list_asset_cloud_storages: %s\n" % e)
```
 ...
 **asset_name** | **str**| Keyword search in a Cloud Storage URL | [optional] 
...
with watchtowr_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of AssetCloudStorageAssetsApi->update_asset_cloud_storage_status:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AssetCloudStorageAssetsApi->update_asset_cloud_storage_status: %s\n" % e)
```
