...
> ClientCloudStorageData get_asset_cloud_storage_details(api_token)
...
with watchtowr_api.ApiClient(configuration) as api_client:
    ...
    try:
        # Show the details of a specific cloud storage asset.
        api_response = api_instance.get_asset_cloud_storage_details(api_token)
...
> PaginatedClientCloudStorage get_list_asset_cloud_storages(asset_name=asset_name, statuses=statuses, business_unit_ids=business_unit_ids, page=page, created_from=created_from, created_to=created_to, updated_from=updated_from, updated_to=updated_to)
...
with watchtowr_api.ApiClient(configuration) as api_client:
    ...
    try:
        # List all discovered cloud storage assets, ordered by date identified.
        api_response = api_instance.get_list_asset_cloud_storages(asset_name=asset_name, statuses=statuses, business_unit_ids=business_unit_ids, page=page, created_from=created_from, created_to=created_to, updated_from=updated_from, updated_to=updated_to)
