...
class AssetCloudStorageAssetsApi:
    ...
    def get_list_asset_cloud_storages(
        ...
        asset_name: Annotated[Optional[StrictStr], Field(description="Keyword search in a Cloud Storage URL")] = None,
        ...
        :param asset_name: Keyword search in a Cloud Storage URL
        :type asset_name: str
