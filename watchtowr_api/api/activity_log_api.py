...
class ActivityLogApi:
    ...
    def get_list_activity_logs(
        ...
        created_from: Annotated[Optional[datetime], Field(description="Start Date")] = None,
        created_to: Annotated[Optional[datetime], Field(description="End Date")] = None,
        types: Annotated[Optional[List[StrictStr]], Field(description="Subject types")] = None,
        search: Annotated[Optional[StrictStr], Field(description="Description keyword")] = None,
        user_ids: Annotated[Optional[List[StrictStr]], Field(description="User IDs")] = None,
        ...
        :param created_from: Start Date
        :type created_from: datetime
        :param created_to: End Date
        :type created_to: datetime
        :param types: Subject types
        :type types: List[str]
        :param search: Description keyword
        :type search: str
