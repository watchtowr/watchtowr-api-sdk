...
class SuspiciousDomainsApi:
    ...
    def get_list_suspicious_domain(
        ...
        discovery_reason: Annotated[Optional[StrictStr], Field(description="Search Discovery Reason")] = None,
        whois_search: Annotated[Optional[StrictStr], Field(description="Search Whois Data")] = None,
        ...
        :type search: str
        :param discovery_reason: Search Discovery Reason
        :type discovery_reason: str
        :param whois_search: Search Whois Data
