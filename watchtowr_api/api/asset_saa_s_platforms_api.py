...
class AssetSaaSPlatformsApi:
    ...
    def get_list_asset_saas_platforms(
        ...
        asset_name: Annotated[Optional[StrictStr], Field(description="Keyword search in a SaaS Platform URL")] = None,
        ...
        :param asset_name: Keyword search in a SaaS Platform URL
        :type asset_name: str
