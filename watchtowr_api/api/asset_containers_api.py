...
class AssetContainersApi(object):
    ...
    @validate_arguments
    def get_asset_container_details(self, api_token : StrictStr, **kwargs) -> ClientContainerData:  # noqa: E501
        """Show the details of a specific container asset.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_asset_container_details(api_token, async_req=True)
        >>> result = thread.get()
        ...
        :rtype: ClientContainerData
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the get_asset_container_details_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.get_asset_container_details_with_http_info(api_token, **kwargs)  # noqa: E501

    @validate_arguments
    def get_asset_container_details_with_http_info(self, api_token : StrictStr, **kwargs) -> ApiResponse:  # noqa: E501
        """Show the details of a specific container asset.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_asset_container_details_with_http_info(api_token, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ClientContainerData, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method get_asset_container_details" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/client/assets/container/show/{id}', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def get_list_asset_container(self, asset_name : Annotated[Optional[StrictStr], Field(description="Asset name/SaaS URL/IP/IP Range/Port")] = None, statuses : Annotated[Optional[conlist(StrictStr)], Field(description="Asset statuses")] = None, business_unit_ids : Annotated[Optional[StrictStr], Field(description="Comma separated list of business unit IDs")] = None, page : Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="Pagination page")] = None, created_from : Annotated[Optional[datetime], Field(description="created_at Date Range Beginning")] = None, created_to : Annotated[Optional[datetime], Field(description="created_at Date Range Ending")] = None, updated_from : Annotated[Optional[datetime], Field(description="updated_at Date Range Beginning")] = None, updated_to : Annotated[Optional[datetime], Field(description="updated_at Date Range Ending")] = None, **kwargs) -> PaginatedClientContainer:  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: PaginatedClientContainer
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the get_list_asset_container_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.get_list_asset_container_with_http_info(asset_name, statuses, business_unit_ids, page, created_from, created_to, updated_from, updated_to, **kwargs)  # noqa: E501
    ...
    def get_list_asset_container_with_http_info(self, asset_name : Annotated[Optional[StrictStr], Field(description="Asset name/SaaS URL/IP/IP Range/Port")] = None, statuses : Annotated[Optional[conlist(StrictStr)], Field(description="Asset statuses")] = None, business_unit_ids : Annotated[Optional[StrictStr], Field(description="Comma separated list of business unit IDs")] = None, page : Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="Pagination page")] = None, created_from : Annotated[Optional[datetime], Field(description="created_at Date Range Beginning")] = None, created_to : Annotated[Optional[datetime], Field(description="created_at Date Range Ending")] = None, updated_from : Annotated[Optional[datetime], Field(description="updated_at Date Range Beginning")] = None, updated_to : Annotated[Optional[datetime], Field(description="updated_at Date Range Ending")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.get_list_asset_container_with_http_info(asset_name, statuses, business_unit_ids, page, created_from, created_to, updated_from, updated_to, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(PaginatedClientContainer, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_list_asset_container" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/client/assets/container/list', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
