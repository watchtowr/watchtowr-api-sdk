...
class AssetSubdomainsApi:
    ...
    def get_list_asset_subdomains(
        ...
        asset_name: Annotated[Optional[StrictStr], Field(description="Keyword search in a Subdomain")] = None,
        ...
        :param asset_name: Keyword search in a Subdomain
        :type asset_name: str
