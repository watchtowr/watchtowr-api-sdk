...
class AssetDomainsApi:
    ...
    def get_list_asset_domains(
        ...
        asset_name: Annotated[Optional[StrictStr], Field(description="Keyword search in a Domain")] = None,
        ...
        :param asset_name: Keyword search in a Domain
        :type asset_name: str
