...
class ClientBusinessUnit(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClientBusinessUnit:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClientBusinessUnit:
        """Create an instance of ClientBusinessUnit from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClientBusinessUnit.parse_obj(obj)

        _obj = ClientBusinessUnit.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name")
        })
        return _obj
