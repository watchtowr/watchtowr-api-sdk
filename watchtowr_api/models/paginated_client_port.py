...
class PaginatedClientPort(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaginatedClientPort:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaginatedClientPort:
        """Create an instance of PaginatedClientPort from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaginatedClientPort.parse_obj(obj)

        _obj = PaginatedClientPort.parse_obj({
            "data": [ClientPort.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
