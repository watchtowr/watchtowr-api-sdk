...
class PaginatedClientMobileApp(BaseModel):
    ...
    """
    data: conlist(ClientMobileApp) = Field(...)
    meta: Meta = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaginatedClientMobileApp:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaginatedClientMobileApp:
        """Create an instance of PaginatedClientMobileApp from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaginatedClientMobileApp.parse_obj(obj)

        _obj = PaginatedClientMobileApp.parse_obj({
            "data": [ClientMobileApp.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
