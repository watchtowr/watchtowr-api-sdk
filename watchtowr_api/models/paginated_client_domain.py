...
class PaginatedClientDomain(BaseModel):
    ...
    """
    data: conlist(ClientDomain) = Field(...)
    meta: Meta = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaginatedClientDomain:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaginatedClientDomain:
        """Create an instance of PaginatedClientDomain from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaginatedClientDomain.parse_obj(obj)

        _obj = PaginatedClientDomain.parse_obj({
            "data": [ClientDomain.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
