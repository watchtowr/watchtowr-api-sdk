...
class ClientContainer(BaseModel):
    ...
    __properties = ["type", "source", "status", "created_at", "updated_at", "deleted_at", "id", "name", "owner", "platform", "url", "businessUnits"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClientContainer:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClientContainer:
        """Create an instance of ClientContainer from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClientContainer.parse_obj(obj)

        _obj = ClientContainer.parse_obj({
            "type": obj.get("type"),
