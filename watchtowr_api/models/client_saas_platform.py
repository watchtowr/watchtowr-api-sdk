...
class ClientSaasPlatform(BaseModel):
    ...
    __properties = ["type", "source", "status", "created_at", "updated_at", "deleted_at", "id", "url", "provider", "businessUnits"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClientSaasPlatform:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClientSaasPlatform:
        """Create an instance of ClientSaasPlatform from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClientSaasPlatform.parse_obj(obj)

        _obj = ClientSaasPlatform.parse_obj({
            "type": obj.get("type"),
