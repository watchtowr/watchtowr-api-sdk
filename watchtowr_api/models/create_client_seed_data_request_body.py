...
class CreateClientSeedDataRequestBody(BaseModel):
    ...
    """ # noqa: E501
    data: List[ClientSeedData] = Field(description="List of Seed Data")
    business_units: Optional[List[Dict[str, Any]]] = Field(default=None, description="List of Business Unit", alias="businessUnits")
