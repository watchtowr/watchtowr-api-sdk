...
class PaginatedBusinessUnit(BaseModel):
    ...
    """
    data: conlist(ClientBusinessUnitDetail) = Field(...)
    meta: Meta = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaginatedBusinessUnit:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaginatedBusinessUnit:
        """Create an instance of PaginatedBusinessUnit from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaginatedBusinessUnit.parse_obj(obj)

        _obj = PaginatedBusinessUnit.parse_obj({
            "data": [ClientBusinessUnitDetail.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
