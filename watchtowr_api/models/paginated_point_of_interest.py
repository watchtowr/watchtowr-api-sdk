...
class PaginatedPointOfInterest(BaseModel):
    ...
    """
    data: conlist(PointsOfInterest) = Field(...)
    meta: Meta = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaginatedPointOfInterest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaginatedPointOfInterest:
        """Create an instance of PaginatedPointOfInterest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaginatedPointOfInterest.parse_obj(obj)

        _obj = PaginatedPointOfInterest.parse_obj({
            "data": [PointsOfInterest.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
