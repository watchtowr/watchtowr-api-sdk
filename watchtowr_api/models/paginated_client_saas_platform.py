...
class PaginatedClientSaasPlatform(BaseModel):
    ...
    """
    data: conlist(ClientSaasPlatform) = Field(...)
    meta: Meta = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaginatedClientSaasPlatform:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaginatedClientSaasPlatform:
        """Create an instance of PaginatedClientSaasPlatform from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaginatedClientSaasPlatform.parse_obj(obj)

        _obj = PaginatedClientSaasPlatform.parse_obj({
            "data": [ClientSaasPlatform.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
