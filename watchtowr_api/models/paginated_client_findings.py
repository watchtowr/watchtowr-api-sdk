...
class PaginatedClientFindings(BaseModel):
    ...
    """
    data: conlist(ClientFinding) = Field(...)
    meta: Meta = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaginatedClientFindings:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaginatedClientFindings:
        """Create an instance of PaginatedClientFindings from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaginatedClientFindings.parse_obj(obj)

        _obj = PaginatedClientFindings.parse_obj({
            "data": [ClientFinding.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
