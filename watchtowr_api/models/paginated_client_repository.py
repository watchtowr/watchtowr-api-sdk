...
class PaginatedClientRepository(BaseModel):
    ...
    """
    data: conlist(ClientRepository) = Field(...)
    meta: Meta = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaginatedClientRepository:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaginatedClientRepository:
        """Create an instance of PaginatedClientRepository from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaginatedClientRepository.parse_obj(obj)

        _obj = PaginatedClientRepository.parse_obj({
            "data": [ClientRepository.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
