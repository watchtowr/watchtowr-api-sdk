...
class PaginatedServiceListing(BaseModel):
    ...
    """
    data: conlist(ServiceListing) = Field(...)
    meta: Meta = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaginatedServiceListing:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaginatedServiceListing:
        """Create an instance of PaginatedServiceListing from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaginatedServiceListing.parse_obj(obj)

        _obj = PaginatedServiceListing.parse_obj({
            "data": [ServiceListing.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
