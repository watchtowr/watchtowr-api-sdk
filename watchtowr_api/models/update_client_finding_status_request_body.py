...
class UpdateClientFindingStatusRequestBody(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateClientFindingStatusRequestBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateClientFindingStatusRequestBody:
        """Create an instance of UpdateClientFindingStatusRequestBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateClientFindingStatusRequestBody.parse_obj(obj)

        _obj = UpdateClientFindingStatusRequestBody.parse_obj({
