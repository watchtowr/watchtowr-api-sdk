...
class ClientRepository(BaseModel):
    ...
    __properties = ["type", "source", "status", "created_at", "updated_at", "deleted_at", "id", "name", "owner", "provider", "businessUnits"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClientRepository:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClientRepository:
        """Create an instance of ClientRepository from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClientRepository.parse_obj(obj)

        _obj = ClientRepository.parse_obj({
            "type": obj.get("type"),
