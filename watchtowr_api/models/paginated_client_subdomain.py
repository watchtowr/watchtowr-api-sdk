...
class PaginatedClientSubdomain(BaseModel):
    ...
    """
    data: conlist(ClientSubdomain) = Field(...)
    meta: Meta = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaginatedClientSubdomain:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaginatedClientSubdomain:
        """Create an instance of PaginatedClientSubdomain from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaginatedClientSubdomain.parse_obj(obj)

        _obj = PaginatedClientSubdomain.parse_obj({
            "data": [ClientSubdomain.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
