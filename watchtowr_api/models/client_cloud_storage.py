...
class ClientCloudStorage(BaseModel):
    ...
    __properties = ["type", "source", "status", "created_at", "updated_at", "deleted_at", "id", "name", "platform", "url", "businessUnits"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClientCloudStorage:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClientCloudStorage:
        """Create an instance of ClientCloudStorage from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClientCloudStorage.parse_obj(obj)

        _obj = ClientCloudStorage.parse_obj({
            "type": obj.get("type"),
