...
class PaginatedClientCloudStorage(BaseModel):
    ...
    """
    data: conlist(ClientCloudStorage) = Field(...)
    meta: Meta = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaginatedClientCloudStorage:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaginatedClientCloudStorage:
        """Create an instance of PaginatedClientCloudStorage from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaginatedClientCloudStorage.parse_obj(obj)

        _obj = PaginatedClientCloudStorage.parse_obj({
            "data": [ClientCloudStorage.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
