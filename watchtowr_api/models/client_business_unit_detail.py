...
class ClientBusinessUnitDetail(BaseModel):
    ...
    __properties = ["id", "name", "description", "created_at"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClientBusinessUnitDetail:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClientBusinessUnitDetail:
        """Create an instance of ClientBusinessUnitDetail from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClientBusinessUnitDetail.parse_obj(obj)

        _obj = ClientBusinessUnitDetail.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
