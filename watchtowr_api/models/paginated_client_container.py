...
class PaginatedClientContainer(BaseModel):
    ...
    """
    data: conlist(ClientContainer) = Field(...)
    meta: Meta = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaginatedClientContainer:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaginatedClientContainer:
        """Create an instance of PaginatedClientContainer from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaginatedClientContainer.parse_obj(obj)

        _obj = PaginatedClientContainer.parse_obj({
            "data": [ClientContainer.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
