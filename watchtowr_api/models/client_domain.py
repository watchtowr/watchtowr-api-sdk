...
class ClientDomain(BaseModel):
    ...
    def status_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('verified', 'Third Party', 'Unregistered', 'Incorrect Identification', 'pending', 'VerifiedOutOfScope', 'VerifiedReducedAttack', 'Parked'):
            raise ValueError("must be one of enum values ('verified', 'Third Party', 'Unregistered', 'Incorrect Identification', 'pending', 'VerifiedOutOfScope', 'VerifiedReducedAttack', 'Parked')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClientDomain:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClientDomain:
        """Create an instance of ClientDomain from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClientDomain.parse_obj(obj)

        _obj = ClientDomain.parse_obj({
            "type": obj.get("type"),
