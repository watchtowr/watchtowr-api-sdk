...
class ClientPort(BaseModel):
    ...
    ip: StrictStr = Field(...)
    ip_id: Union[StrictFloat, StrictInt] = Field(...)
    port: Union[StrictFloat, StrictInt] = Field(...)
    banner: StrictStr = Field(...)
    service: StrictStr = Field(...)
    business_units: conlist(ClientBusinessUnit) = Field(..., alias="businessUnits")
    __properties = ["type", "status", "created_at", "updated_at", "deleted_at", "id", "ip", "ip_id", "port", "banner", "service", "businessUnits"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClientPort:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClientPort:
        """Create an instance of ClientPort from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClientPort.parse_obj(obj)

        _obj = ClientPort.parse_obj({
            "type": obj.get("type"),
